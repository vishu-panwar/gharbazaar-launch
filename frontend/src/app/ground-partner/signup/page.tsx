...
import { Mail, Phone, MapPin, Shield, CheckCircle, Users, ArrowRight } from 'lucide-react'
...
export default function GroundPartnerSignupPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-blue-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 flex">
      {/* Left Side - Features */}
